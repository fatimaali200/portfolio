...
const Projects = () => {
  return (
    <section id="project" className="max-w-container mx-auto lgl:px-20 py-24">
        ...
        <div className="flex flex-col xl:flex-row gap-6">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 justify-between items-end text-right xl:-ml-16 z-10 ">
            ...
            <p className="bg-[#112240] text-sm md:text-base p-2 md:p-6 rounded-md">
              ...
              selection of delicious homemade dishes. Our mission is to create a
              vibrant community where people can connect over a shared love for
              good food and support local culinary talents.
            </p>
      ...
      {/** project two */}
      {/** project two */}
      <div className="w-full flex flex-col items-center justify-center gap-28 mt-14">
